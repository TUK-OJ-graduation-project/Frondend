...
<div className="container">
    ...
    <h3>Add Problem</h3><br />
    <div className="container2">
    <div>
      <label htmlFor="level" className="level-label">level</label>
      <select id="level"  name="level"
      onChange={handleChange}
      defaultValue=""
      required>
        <option value="" disabled hidden>문제 난이도</option>
    ...
    <div className="flex items-start mb-6">
      ...
      <div className="language-checkbox">
        <label title="GCC 7.5">
        <input type="checkbox" name="language" value="c" checked={problem.language.includes('c')} onChange={handleCheckboxChange} /> C
        </label>
      <label title="G++ 7.5">
      <input type="checkbox" name="language" value="c++" checked={problem.language.includes('c++')} onChange={handleCheckboxChange} /> C++
      </label>
      <label title="OpenJDK 1.8">
      <input type="checkbox" name="language" value="java"  checked={problem.language.includes('java')} onChange={handleCheckboxChange}/> Java
      </label>
      <label title="Python 3.6">
      <input type="checkbox" name="language" value="python3" checked={problem.language.includes('python3')} onChange={handleCheckboxChange}/> Python3
      </label>
      </div>
      <label htmlFor="type" className="type"></label>
      <select id="type"  name="type" defaultValue="" onChange={handleChange} required>
        <option value="" disabled hidden>문제 유형</option>
    ...
    <div className="btn">
      <button onClick={handleSubmit} type="button" className="submit-btn">Save</button>
    </div>
